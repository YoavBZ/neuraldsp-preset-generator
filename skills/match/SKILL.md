...
the output gain to the reamp's loudness (listed under `level_trims` in
`summary.json`); other regimes leave the output level to the search. A residual-weighted paired run must
